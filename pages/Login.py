...
# Set constants
DATA_FILE = "AnxietyLoginTable.csv"
...
def main():
    ...
    if not st.session_state['authentication']:
        ...
        page = st.sidebar.selectbox("Select a page", ["Dashboard", "Profile", "Logout"])
        ...
        if page == "Dashboard":
            ...
            st.session_state['authentication'] = False
            st.experimental_rerun()  # Rerun the app to display the login/register options
