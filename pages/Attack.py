...
def show():
    ...
    if answer == "Yes":
        switch_pages("Anxiety_Attack_Protocol")  # Hier wird der Dateiname als Zeichenkette übergeben
    else:
        answer_2 = st.radio("Are you anxious right now?", ("Yes", "No"))
        if answer_2 == "Yes":
            switch_pages("Anxiety_protocol")  # Hier wird der Dateiname als Zeichenkette übergeben
        else:
