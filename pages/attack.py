...
def show():
    ...
    if answer == "Yes":
        st.switch_pages("pages/anxiety_attack_protocol.py")  # Hier wird der Dateiname als Zeichenkette übergeben
    else:
        answer_2 = st.radio("Are you anxious right now?", ("Yes", "No"))
        if answer_2 == "Yes":
            st.switch_pages("pages/anxiety_protocol.py")  # Hier wird der Dateiname als Zeichenkette übergeben
        else:
